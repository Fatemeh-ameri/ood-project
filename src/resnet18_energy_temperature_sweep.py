...
print()
print("Temperature | Energy AUROC")
print("--------------------------")
...
for temperature in temperatures:
    ...
    # Energy-style score:
    # Higher score is treated as more likely to be known.
    ...
    print(f"{temperature:11} | {auroc:.4f}")
...
print(f"Best Energy AUROC: {best_auroc:.4f}")